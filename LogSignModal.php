                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                              ...
                              <input class="proid" type="hidden" name="proid" id="proid" value="">
                                <div class="form-group">
                                  <div class="col-md-10">
                                    ...
                                    <div class="col-md-8">
                                       <input   id="U_USERNAME" name="U_USERNAME" placeholder="Username" type="text" class="form-control input-sm" required> 
                                ...
                                <div class="form-group">
                                  <div class="col-md-10">
                                    ...
                                    <div class="col-md-8">
                                     <input name="U_PASS" id="U_PASS" placeholder="Password" type="password" class="form-control input-sm" required>
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="index.php">Kanoni Hardware</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter
                                           ('terms.php','Terms And Codition','600','600')"  >
                                           <b>TERMS AND CONDITION</b></a> of Kanoni Hardware </small>
