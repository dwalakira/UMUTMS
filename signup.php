  ...
  <div class="navbar  set-radius-zero">
        <div class="container">
            ...
            <div class="navbar-header">
                <h1 style="color: ">
					<p><span class='site-title' style='color: #333; font-family: Stonehenge Regular; text-align:center; float: right;
					width: 100%; border: none; padding: 1px; margin-left:1px; margin-right:15px; background-color: transparent;'>
				<span style='font-size:150%;'><img src="images/logo Uganda Martyrs University.gif" alt="Person"style="width:5% ">
				<span style='color:#CC1B00;'>U</span>ganda
				<span style='color:#CC1B00;'>M</span>artyrs
				<span style='color:#CC1B00;'>U</span>niversity</span></span></p>
                </h1>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
              <img src="images/lib.png" alt="UMU log" style="width:25%" padding="10px" Float:center>
              <img src="images/umumaian.png" alt="UMU log" style="width:20%" padding="10px" Float:center>
               <img src="images/LRM_EXPORT_27905087296000_20190816_084506603.jpeg" alt="UMU log" style="width:20%" padding="10px" Float:center>
                <img src="images/LRM_20200131_133136.jpg" alt="UMU log" style="width:30%" padding="10px" Float:center>
