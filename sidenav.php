...
switch ($usergroup) {
  ...
  default:
		# code...
  echo '<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Faculty">
  <a class="nav-link" href="schools_view.php">
  <i class="fa fa-fw fa-building"></i>
  <span class="nav-link-text">Faculties</span>
  </a>
  </li>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Course Units">
  <a class="nav-link" href="departments_view.php">
  <i class="fa fa-fw fa-pie-chart"></i>
  <span class="nav-link-text">Course Units</span>
  </a>
  </li>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Students">
  <a class="nav-link" href="student_details_view.php">
  <i class="fa fa-fw fa-users"></i>
  <span class="nav-link-text">Students Details</span>
  </a>
  </li>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Time Table">
  <a class="nav-link" href="class_time_table_view.php">
  <i class="fa fa-fw fa-file"></i>
