	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i>   UMU TMS </a>
				<h1 style="color: ">
				...
				<span style='font-size:100%;'><img src="images/logo Uganda Martyrs University.gif" alt="Person"style="width:5% ">
